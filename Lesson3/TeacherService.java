...
public class TeacherService implements UserService < Teacher >
{
  ...
  private Integer maxTeacherId = 0;
   @Override public List < Teacher > getAll ()
  {
    return teacherList;
  }

   @Override public void initData (List < Teacher > list)
  {
  ...
  {
    Teacher teacher =
      new Teacher (++maxTeacherId, surname, firstname, patronymic);
    teacherList.add (teacher);
  }
  public void editTeacher (Integer teacherId, String surname,
